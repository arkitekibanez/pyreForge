__title__ = "Family>Lowercase"
__doc__ = """Version = 1.0
Date    = 26.06.2024
__________________________________________________________________
Description:
Change the families names to lowercase.
...
if result == TaskDialogResult.Yes:
    ...
    with Transaction(doc, 'Update Loaded Family Names') as t:
        ...
        for family_symbol in loaded_families:
            ...
            updated_family_name = family_name.lower()  # Change to lowercase
    ...
    task_dialog.MainContent = "All Loaded Family names changed to lowercase successfully"
    task_dialog.Show()
else:
